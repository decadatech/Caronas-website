<?php
    ...
    if(isset($_POST['checkBack'])){
        ...
        $query = "INSERT INTO `tb03_contato`(`tb03_nome`, `tb03_cidade_saida`, `tb03_cidade_chegada`, `tb03_telefone`, `tb03_hora_saida`, `tb03_hora_volta`, `tb03_quant_passageiro`, `tb03_email`, `tb03_observacoes`, `tb03_hora_cadastro`) VALUES ('".$nome."', '".$cidadeS."', '".$cidadeC."', '".$telefone."', '".$horaS."', '".$horaV."', '".$passageiros."', '".$email."', '".$observacoes."', NOW())";
    }else{
      ...
      $query = "INSERT INTO `tb03_contato`(`tb03_nome`, `tb03_cidade_saida`, `tb03_cidade_chegada`, `tb03_telefone`, `tb03_hora_saida`, `tb03_quant_passageiro`, `tb03_email`, `tb03_observacoes`, `tb03_hora_cadastro`) VALUES ('".$nome."', '".$cidadeS."', '".$cidadeC."', '".$telefone."', '".$horaS."', '".$passageiros."', '".$email."', '".$observacoes."', NOW())";
    }
